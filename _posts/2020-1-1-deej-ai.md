...
Using data from Spotify, I trained neural networks to come up with two different representations for organizing music either by similar artists or by similar sounding tracks (in terms of energy, mood, rhythm or instrumentation). A "creativity" parameter allows you to mix the two.
